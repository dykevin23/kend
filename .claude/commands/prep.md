...
## 1. 진행상황 (먼저 읽을 것)
- `readme/overview.md` — **이 프로젝트의 현재 상태 단일 대시보드** (최우선)
- `readme/kend-milestones.md` — 출시까지 **전체 Phase 진행 트래커** (플랫폼 공통, canonical: kend)
- `readme/changelog-kend.md` — **이 프로젝트**의 변경 이력
- `readme/changelog-native.md`, `readme/changelog-seller.md` — **타 패키지 진행상황**
...
- `readme/core/database.md` — DB 구조
- `readme/core/` 하위 나머지 도메인 문서 (결제, 주문/배송 설계 등)

## 3. 계획 / 작업 문서
- `readme/kend-roadmap-to-launch.md` — 출시 로드맵 (안정적 계획)
- `readme/active/` — 진행 중인 작업 계획
- `readme/todo/` — 예정 작업 계획
