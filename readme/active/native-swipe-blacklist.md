...
> 구현: [kend-native/app/index.tsx](../../kend-native/app/index.tsx)
> 결제 WebView 이슈 상세는 [todo/native-payment-webview-handoff.md](../todo/native-payment-webview-handoff.md)
...
- 결제 흐름(kend): `app/features/payments/pages/`, `app/features/products/components/product-purchase-modal.tsx`
- 인계/테스트 체크리스트: [todo/native-payment-webview-handoff.md](../todo/native-payment-webview-handoff.md)
